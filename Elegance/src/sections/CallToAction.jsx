    ...
    >
      <article className="flex max-w-[1450px] flex-col gap-4 px-8 md:px-0">
        ...
        <div className="flex justify-center items-center flex-col md:flex-row gap-4 mt-4">
          ...
          <a className="px-6 py-2 rounded-md w-fit font-primary  text-white border-white border text-2xl cursor-pointer animated-button whitespace-nowrap min-w-fit">
            Sprawdź ofertę
          </a>
        </div>
      </article>
